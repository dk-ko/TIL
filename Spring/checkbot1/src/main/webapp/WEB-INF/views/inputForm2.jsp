	...
	<form:form method="post" modelAttribute="inputFormModel">
		<div class="form-group">
			...
			<div class="radio-list">
				<form:radiobuttons path="color1" items="${ colors }"/>
			</div>
		</div>
		<div class="form-group">
			<label>선택2:</label>
			<div class="checkbox-list">
				<form:checkboxes path="color2" items="${ colors }"/>
			</div>
		</div>
		<div class="form-group">
			<label>선택3:</label>
			<div class="checkbox-list">
				<form:select path="color3" class="form-control" style="width:200px;" items="${ colors }"/>
			</div>
		</div>
		<div class="form-group">
